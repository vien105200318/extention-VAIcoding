...
interface Task {
    ...
    details?: string; // Thêm trường này
    documentationLinks?: { title: string, url: string }[]; // Thêm trường này
}
...
export function activate(context: vscode.ExtensionContext) {
    ...
    const disposables = [
        ...
        vscode.commands.registerCommand('gemini-code-assistant.showDashboard', () => {
            ...
            dashboardPanel.webview.onDidReceiveMessage(async message => { // Thêm async ở đây
